...
const AdminDashboard = () => {
  ...
  const fetchTickets = async () => {
    ...
    try {
      ...
      setError(
        "Failed to load incidents. Please check if the backend service is running.",
      );
    } finally {
      setLoading(false);
    }
      ...
      <div className="content-area">
        <div className="dashboard-header">
          ...
          <p className="subtitle">
            High-level statistics for campus incident management.
          </p>
        </div>
        ...
        <div className="admin-quick-actions">
          ...
          <div className="action-links">
            ...
            <div className="action-card">
              ...
              <p>View and manage campus facilities as an administrator.</p>
              <Link
                to="/facilities?role=admin"
                style={{
                  color: "#2563eb",
                  fontWeight: 700,
                  textDecoration: "none",
